...
export default {
  ...
  created() {
    ...
    this.touch = {} // 该touch仅需要在两个模块中获取不需要观测，因此不用放在data、props或computed
    this.listHeight = []
  },
  computed: {
    shortcutlist() {
  ...
  methods: {
    ...
    onShortcutTouchMove(e) {
      let firstTouch = e.touch[0]
      this.touchy2 = firstTouch.pageY
...
<template>
<!-- @scroll="scroll" :listen-scroll="listenScroll" :probe-type="probeType"-->
